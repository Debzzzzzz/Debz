...
Function Invoke-WPFFormVariables {
	...
	Write-Host ""
    Write-Host " ____  _____________   _________"
	Write-Host " \   \/  /\______   \ /   _____/"
	Write-Host "  \     /  |     ___/ \_____  \ "
	Write-Host "  /     \  |    |     /        \"
	Write-Host " /___/\  \ |____|    /_______  /"
    Write-Host "       \_/                   \/ "
	Write-Host ""
...
$inputXML = '<Window x:Class="WinUtility.MainWindow"
        ...
        Title="XPS All in one installers" Height="550" Width="400">
    <Window.Resources>
    ...
    <Border Name="dummy" Grid.Column="0" Grid.Row="0">
        <Viewbox Stretch="Uniform" VerticalAlignment="Top">
            <Grid Background="#777777" ShowGridLines="False" Name="MainGrid">
                ...
                <DockPanel Background="#777777" SnapsToDevicePixels="True" Grid.Row="0" Width="175">
                    <Image Height="50" Width="100" Name="Icon" SnapsToDevicePixels="True" Source="https://assets.bossjob.com/companies/1925/logo/wN89enxi2bAXeQusvjQhZcA25NWTL6sdoEmdWHtR.png" Margin="0,10,0,10"/>
                    <Button Content="Installers" HorizontalAlignment="Left" Height="40" Width="60" Background="#222222" BorderThickness="0,0,0,0" FontWeight="Bold" Foreground="#ffffff" Name="Tab1BT"/>
                    
                </DockPanel>
                <TabControl Grid.Row="1" Padding="-5" Name="TabNav" Background="#222222">
                    <TabItem Header="Installers" Visibility="Collapsed" Name="Tab1">
                        <Grid Background="#222222">
                            ...
                            <StackPanel Background="#777777" SnapsToDevicePixels="False" Grid.Column="0" Margin="10">
								...
								<CheckBox Name="Installauthy" Content="Authy" Margin="5,0"/>
                                ...
                                <Button Name="InstallUpgrade" Background="AliceBlue" Content="Update all Apps" HorizontalAlignment = "Left" Margin="5,0,0,5" Padding="20,5" Width="150" ToolTip="Upgrade All Existing Programs on System"/>
